...
## Alpha Omega Coin (AOC) Bep20 V2 Token 

## Table of Contents
1. [Overview](#overview)
2. [Alpha Omega Coin (AOC) Bep20 V2 Token Identification Details](#token-identification-details)   
...
By limiting the monthly transaction of AOC BEP20 V2 token over several months or years through  the RAMS / RAMF / RAMA/ RAMP / RA2M, AOC CORE TEAM is showing their willingness which consists in stabilizing, durably and permanently, the price, the value and the market of AOC Mother Coin and AOC tokens, including AOC BEP20 V2 token.
